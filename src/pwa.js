...
const PWA_BUILD='ride-dash-page-lock-v32';
const ACTIVE_CACHES=['motocloud-app-v32','motocloud-runtime-v32','motocloud-images-v32'];
  ...
  window.addEventListener('load',async()=>{
    try{
      ...
      registration.addEventListener('updatefound',()=>{
        ...
        worker.addEventListener('statechange',()=>{if(worker.state==='activated'){void clearLegacyMotoCaches();console.info('Moto Mission Ride Dash stability v32 installed.');window.dispatchEvent(new CustomEvent('moto-app-cache-updated'))}})
      });
